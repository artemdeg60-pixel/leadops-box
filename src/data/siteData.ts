...
export const pricingPlans = [
  {
    ...
    featured: false,
    items: [
      "Проверить, подходит ли система бизнесу",
      "Минимальная рабочая версия",
      "1 базовая форма",
      "1 Telegram-чат",
      "1 простая таблица",
      "Базовое краткое резюме заявки",
      "Простое напоминание, если лид не обработан",
      "Базовая проверка работы",
      "Минимальная",
      "Кто хочет быстро попробовать",
    ],
  },
  {
    title: "Внедрение",
    ...
    featured: true,
    items: [
      "Полноценно запустить систему под компанию",
      "Настроенный рабочий контур под процессы клиента",
      "Форма адаптируется под нишу, поля и логику клиента",
      "Отдельный Telegram-чат + более продуманная карточка лида",
      "Таблица под структуру клиента: статусы, поля, контроль обработки",
      "Более точная AI-логика под нишу и типы заявок",
      "Настроенная логика напоминаний: сроки, условия, статусы",
      "Полное тестирование сценария на реальных/тестовых заявках",
      "Краткая инструкция для клиента/менеджера",
      "Кто хочет реально использовать систему в работе",
    ],
  },
  {
    title: "Сопровождение",
